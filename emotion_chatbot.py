...
def load_models():
    ...
    try:
        ...
        THERABOT_SYSTEM_PROMPT = (
            ...
            "- [Headspace🧘‍♂️](https://www.headspace.com) - Guided meditation and mindfulness\n"
            "- [Calm](https://www.calm.com) - Sleep, meditation and relaxation\n"
            "- [Insight Timer](https://insighttimer.com) - Free meditation app\n"
            "- [Ten Percent Happier](https://www.tenpercent.com) - Meditation for skeptics\n\n"
            "MENTAL HEALTH SUPPORT:\n"
            "- [BetterHelp](https://www.betterhelp.com) - Online therapy platform\n"
            "- [7 Cups](https://www.7cups.com) - Free emotional support\n"
            "- [Find A Helpline🆘](https://findahelpline.com) - Crisis support worldwide\n"
            "- [Crisis Text Line](https://www.crisistextline.org) - 24/7 text support\n\n"
            "SELF-HELP TOOLS:\n"
            "- [MoodGym](https://moodgym.com.au) - Interactive CBT training\n"
            "- [Happify](https://www.happify.com) - Activities for emotional wellbeing\n"
            "- [Wysa](https://www.wysa.io) - AI-based mental health support\n"
            "- [Sanvello](https://www.sanvello.com) - Stress and anxiety management\n\n"
            "EDUCATIONAL RESOURCES:\n"
            "- [NIMH](https://www.nimh.nih.gov) - Mental health research & information\n"
            "- [Mind UK](https://www.mind.org.uk) - Mental health support\n"
            "- [HelpGuide](https://www.helpguide.org) - Mental health and wellness guides\n"
            "- [PsychCentral](https://psychcentral.com) - Mental health information\n\n"
            "BREATHING & RELAXATION:\n"
            "- [Breathwrk](https://www.breathwrk.com) - Breathing exercises\n"
            "- [Prana Breath](https://apps.apple.com/us/app/prana-breath-calm-meditate/id1238447223) - Breath work guide\n"
            "- [Healthline Breathing Guide🌬️](https://www.healthline.com/health/breathing-exercise)\n"
        )
